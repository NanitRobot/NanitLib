...
<body>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name=""
                                style="border-radius: 3px; width: auto; height: 30px; margin: 10px;" id="re_ssid"></td>
                        <td><span id="text_ssid" class="buttonWifi_info" style="color:green;"></span></td>
                    </tr>
                    <tr>
                        <td><span class="buttonWifi_info">Password: </span></td>
                        <td><input type="text" name=""
                                style="border-radius: 3px; width: auto; height: 30px;margin: 10px;" id="re_password">
                            <div class="sandvpn-logo"
                    ...
                    <tr>
                        <td colspan="3"><span class="buttonWifi_info">Name Wi-fi hotspot:</span><span
                                style="padding-left: 10px; color:red;" id="text_wifi" class="buttonWifi_info"></span>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div>
        ...
        <div>
            <div class="buttons_game">
                <span class="firm_img"></span><span class="buttonWifi_info" style="padding-left: 20px;">Firmware
                    version: 1.2</span>
            </div>
            <div class="buttons_game">
                <span class="module_img"></span><span class="buttonWifi_info" style="padding-left: 20px;">Module
                    identifier:</span><span class="buttonWifi_info" id="text_serial"></span>
            </div>
            <div class="buttons_game">
                <span class="ip_img"></span><span class="buttonWifi_info" style="padding-left: 20px;">IP:</span><span
                    class="buttonWifi_info" id="text_ip"></span>
            </div>
        </div>
    </div>
    ...
    <footer>
        <p style="bottom:10px; font-size: 23px; font-weight:normal; text-align: center;">
            <button class="button_save" type="button" onclick="send_new()">Save</button>
        </p>
    </footer>
